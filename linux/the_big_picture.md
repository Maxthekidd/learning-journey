...
What surprised me is the extent to which computers go in order to generate randomness. But this is completely understandable from a security standpoint.

## User Space
It is basically userland where user processes run. It includes everything that the user interacts with on a day-to-day basis.
...
The fact that a single system can have up to multiple users surprised me.
